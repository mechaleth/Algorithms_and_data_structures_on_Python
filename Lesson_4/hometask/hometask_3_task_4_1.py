...
#      1    0.000    0.000    0.000    0.000 hometask_3_task_4_1.py:22(get_most_frequent)
#      1    0.000    0.000    0.000    0.000 {built-in method builtins.exec}
#      1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
#     10    0.000    0.000    0.000    0.000 {method 'keys' of 'dict' objects}
# timeit
# 1000 loops, best of 5: 4.58 usec per loop
...
#     10    0.000    0.000    0.000    0.000 {method 'keys' of 'dict' objects}
# timeit
# 1000 loops, best of 5: 4.97 usec per loop
...
# timeit
# 1000 loops, best of 5: 42.4 usec per loop
...
# 904 function calls in 0.005 seconds
# ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#      1    0.000    0.000    0.001    0.001 <string>:1(<module>)
#      1    0.001    0.001    0.001    0.001 hometask_3_task_4_1.py:22(get_most_frequent)
#      1    0.004    0.004    0.005    0.005 {built-in method builtins.exec}
#      1    0.000    0.000    0.000    0.000 {method 'disable' of '_lsprof.Profiler' objects}
#    900    0.000    0.000    0.000    0.000 {method 'keys' of 'dict' objects}
# timeit
# 1000 loops, best of 5: 408 usec per loop
# c 20ю повторениями тестировать не вижу смысла - очевидно, различие будет, но не столь значительное
